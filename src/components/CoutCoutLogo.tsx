...
export default function CoutCoutLogo(props: { animated: boolean }) {
    ...
    return (
        <a
            className="font-extrabold font-tigedeblug flex items-center w-min origin-top-left scale-[1.4] sm:scale-[1.6] md:scale-[1.8] lg:scale-[2] xl:scale-[2.2] 2xl:scale-[2.5]"
            href={"/"}
